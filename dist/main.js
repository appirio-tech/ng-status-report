...
$templateCache.put("views/status-reports.directive.html","<div class=\"flex rows\"><nav><h6>past status reports</h6><past-status-reports work-id=\"{{vm.workId}}\"></past-status-reports></nav><main><h3>create status report</h3><hr class=\"biggest\"/><create-status-report ng-if=\"vm.showCreateReport\"></create-status-report><detail-status-report ng-if=\"vm.showDetailReport\"></detail-status-report></main></div>");}]);
(function() {
  'use strict';
  var directive;
