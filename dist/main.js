...
$templateCache.put("views/status-reports.directive.html","<div class=\"flex rows\"><nav><h6>past status reports</h6><past-status-reports work-id=\"{{vm.workId}}\"></past-status-reports></nav><main><h3>create status report</h3><hr class=\"biggest\"/><create-status-report></create-status-report></main></div>");}]);
(function() {
  'use strict';
  var directive;
